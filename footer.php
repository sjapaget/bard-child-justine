...
<!-- <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/adresse_boutique_blanc.svg" alt=""> -->
...
<footer id="page-footer" class="<?php echo esc_attr(bard_options( 'general_footer_width' )) === 'boxed' ? 'boxed-wrapper ': ''; ?>clear-fix">
  <div class="footer__col">
    ...
    <img class="footer__logo" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/PayPal.svg" alt="PayPal Logo">
    <h6 class="footer__title">Livraison</h6>
    <img class="footer__logo" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/Colissimo.svg" alt="Colissimo Logo">
  </div>
  <div class="footer__col">
    ...
    <img class="footer__logo-labels" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/MesLabels.png" alt="">
  </div>
  <div class="footer__col">
    ...
    <div class="footer__logo--socials-container">
      <a href="https://www.facebook.com/profile.php?id=100030724736732" target="_blank">
        <img class="footer__logo footer__logo-socials-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/justine-fb.png" alt="facebook logo">
      </a>
      <a href="https://www.instagram.com/justinetheodor/" target="_blank">
        <img class="footer__logo footer__logo-socials-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/justine-insta.png" alt="instagram logo">
      </a>
    </div>
  </div>
  <div class="footer__col">
    ...
    <img class="footer__logo-address" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/adresse_boutique_blanc.svg" alt="Social Network logos">
    <p class="footer__text">
